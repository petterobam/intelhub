...
INSERT INTO scheduled_tasks (id, name, task_type, module, script, description, tags, schedule_type, schedule_config, enabled, status, deliver_to, created_at, updated_at)
VALUES (
  'film_daily',
  '影视行业洞察报告',
  'report',
